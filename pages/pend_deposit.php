                                  ...
                                  <span id="ticketInfo">
                                      ...
                                      <table width="100%">
                                        <tbody>
                                          ...
                                          <td align="center">
                                            <!--<input type="checkbox" name="chk_approve" id="chk_approve" onclick="SetDeposit(this.checked)"> verified<br><br> -->
                                            <input type="submit" class="btn btn-success" value="approve" name="action" id="btn_approve" onclick="SetDeposit('approve');"> 
                                            <input type="submit" class="btn btn-warning" value="reject" name="action" id="btn_reject" onclick="SetDeposit('reject');"> 
